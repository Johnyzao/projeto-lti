...
function FormRegisto() {
  ...
  return (
    <Container className="form-container" fluid>
      ...
      <p className="text-center">Informações obrigatórias estão marcadas com um asterisco vermelho (<span className='text-danger'>*</span>).</p>
      <Form name='registo' noValidate onSubmit={formik.handleSubmit} className="text-center">
        <Row>
          <Col xs={12} md={6} className="bg-white d-flex flex-column justify-content-between">
            <div>
              ...
              <Form.Group className="mb-3">
                ...
                <Form.Text className="text-muted">
                  A password deve ter 8 dígitos, uma letra maiúscula, um número e um caractere especial (!,.*).
                </Form.Text>
                <Form.Control.Feedback type="invalid">
                  {formik.errors.pass}
                </Form.Control.Feedback>
